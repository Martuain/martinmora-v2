...
export const insights: Insight[] = [
  {
    ...
    body: [
      ...
      "Before an organization can extract value from any type of AI, it needs four things that have nothing to do with technology: clear ownership of AI-enabled decisions, quality thresholds that define what 'good enough' means for automation or augmentation, escalation paths for edge cases and model errors, and measurement systems that connect AI activity to business outcomes.",
