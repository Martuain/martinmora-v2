      ...
      <main>
        <section className="pt-32 pb-20 section-divider relative overflow-hidden">
          ...
          <div className="container-narrow relative z-10">
            ...
            <Reveal delay={0.1}>
              <h1
                className="display-lg text-[var(--primary)] mb-8"
            ...
            {/* Author note */}
            <Reveal delay={0.2}>
              <div className="mt-20 pt-10 border-t border-[var(--border)] flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--secondary)]">
                    Product Strategy, AI Innovation & Digital Transformation Advisor
                  </p>
                </div>
                <Link
                  ...
                  className="ml-auto text-xs font-semibold text-[var(--accent)] hover:text-[var(--primary)] transition-colors"
                >
                  Connect on LinkedIn →
                </Link>
              </div>
